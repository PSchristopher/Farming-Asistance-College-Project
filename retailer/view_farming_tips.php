            ...
            <div style="background-color:orange;" class="main-menu">
                <div class="menu-inner">
                    ...
                    <ul class="metismenu" id="menu"> 
                            ...
                            <li>
                                <a href="add_complains.php" aria-expanded="true"><i class="ti-palette"></i><b><span style="color:black">POST COMPLAINS </span></b></a>
        </li> 
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                <li><a href="index.php">RETAILERS</a></li>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Farming Tips</h4>
                                        ...
                                        <table class="table text-center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['message'];?><br><?php echo $row['fmessage'];?></td>
