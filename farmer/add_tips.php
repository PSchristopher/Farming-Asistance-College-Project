...
if (isset($_POST["submit"]))
{
    ...
    $fac_name = $_POST['fmessage'];
    
    mysqli_query($con,"INSERT INTO `tip_tb` (`tip_id`,`logid`,`fmessage`) VALUES(NULL,'$id','$fac_name')");
...
<head>
    ...
    <title>Farming Assisstance</title>
    ...
    <div class="page-container"style="background-color:orange;">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.php">Farming Assisstance </a>
                </div>
            </div>
            <div style="background-color:orange;" class="main-menu">
                <div class="menu-inner">
                    ...
                    <ul class="nav offset-menu-tab">
                            ...
                            <li>
                                <a href="add_complains.php" aria-expanded="true"><i class="ti-palette"></i><b><span style="color:black">COMPLAINS </span></b></a>
                            </li> 
                                <li><a href="view_reviews.php" aria-expanded="true"><i class="ti-palette"></i><b><span style="color:black">COMPLAIN STATUS</span></b></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">FARMER FARMING DASHBOARD </h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="fmessage" name ="fmessage" placeholder="Enter message">
