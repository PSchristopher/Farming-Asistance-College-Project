                ...
                <div class="menu-inner">
                    ...
                    <ul class="metismenu" id="menu"> 
                           ...
                           <li>
                                ...
                                <li><a href="view_reviews.php" aria-expanded="true"><i class="ti-palette"></i><b><span style="color:black">COMPLAIN STATUS</span></b></a></li>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-lg-6 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">FEEDBACK DETAILS</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <td>
                                                            <a style="color:red;" href="add_reply.php?reply_id=<?php echo $row['review_id'];?>">
REPLY                                 </a></td>
