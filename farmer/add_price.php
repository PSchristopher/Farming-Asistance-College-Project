...
$tyre_query=mysqli_query($con,"SELECT * FROM `products_tb` WHERE product_id='$pid'");
$tyre_data=mysqli_fetch_assoc($tyre_query);
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST")
   {
       ...
       mysqli_query($con,"UPDATE products_tb  SET pprice='$msg' WHERE product_id='$pid'");
                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Add Product_price</h4>
                                        <form method="POST"  enctype="multipart/form-data">
                                        
                                           
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Product Price</label>
                                                <input type="text" class="form-control" id="pprice" name ="pprice" placeholder="Enter Product description ">
