...
<body>
  ...
  <div class="dropdown-menu dropdown-menu-right">
           <a class="dropdown-item" href="delete_userinfo.php?del_id=<?php echo $row['register_id'];?>">REMOVE</a>
               
               <?php 
               if($row['status']=='0') 

 {?>
                                                       <a class="dropdown-item" href="approve.php?edit_id=<?php echo $row['register_id'];?>">APPROVED</a>
                                                    <?php }  else{
                                                        ?>
                                                        <a class="dropdown-item" href="disapprove.php?edit_id=<?php echo $row['register_id'];?>">NOT APPROVED</a>
                                               <?php } ?>
