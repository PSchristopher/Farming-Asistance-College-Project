...
$pid=$_GET['reply_id'];
$tyre_query=mysqli_query($con,"SELECT * FROM `review_tb` WHERE review_id='$pid'");
$tyre_data=mysqli_fetch_assoc($tyre_query);
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST")
   {
       ...
       mysqli_query($con,"UPDATE review_tb  SET areply='$msg' WHERE review_id='$pid'");
       
       

       echo "<script> alert('Details updated!'); </script>";

       echo "<script> window.location.href='view_complains.php';</script>";  
   }
                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">REPLY FORM..</h4>
                                        <form method="post">

                                           
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">REPLY MESSAGE</label>
                                                <input type="text" class="form-control" id="reply" name ="reply" placeholder="fill with your feedback...">
                                                
                                            </div>
                                            <button type="submit" name ="submit" id="submit" value="submit" class="btn btn-primary mt-4 pr-4 pl-4">Submit</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
