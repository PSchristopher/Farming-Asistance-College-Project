        ...
        <div class="sidebar-menu">
            ...
            <div style="background-color:orange;" class="main-menu">
                ...
                <ul class="metismenu" id="menu"> 
                       ...
                       <li><a href="retailer_products.php" aria-expanded="true"><i class="ti-palette"></i><b><span style="color:black">RETAILER INFO</span></b></a></li>
                   
                     
                       

                       <li>
                           <a href="add_complains.php" aria-expanded="true"><i class="ti-palette"></i><b><span style="color:black">ADD FEEDBACK
                ...
                <div class="row">
                    ...
                    <div>
                        <div class="card"  style="background-color:skyblue;">
                            <div class="card-body">
                                <h4 class="header-title">WANTED PRODUCTS</h4>
